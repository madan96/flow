...
def emission_to_csv(emission_path, output_path=None):
    ...
    if output_path is None:
        output_path = '/home/rishabh/work/unsignalized_intersections/new_data/traffic_data_1.' + 'csv'
...
def emission_to_csv_custom(emission_path, exp_count, output_path=None):
    """Convert an emission file generated by sumo into a csv file.
    ...
    # default output path
    if output_path is None:
        output_path = '/home/rishabh/work/unsignalized_intersections/new_data/traffic_data_' + str(exp_count) + '.' + 'csv'
